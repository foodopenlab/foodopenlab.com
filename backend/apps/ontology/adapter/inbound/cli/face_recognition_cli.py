...
사용 예:
  python apps/ontology/adapter/inbound/cli/face_recognition_cli.py train --epochs 30 --device 0
  python apps/ontology/adapter/inbound/cli/face_recognition_cli.py recognize \
      --image some_face.jpg \
      --weights apps/ontology/resources/yolo_train/runs/face_recognizer/weights/best.pt
"""
...
from ontology.app.dtos.face_recognition_dto import FaceRecognizeQuery, FaceTrainCommand  # noqa: E402
from ontology.dependencies.face_recognition_provider import get_face_recognition_use_case  # noqa: E402
