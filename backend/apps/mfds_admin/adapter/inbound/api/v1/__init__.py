...
from mfds_admin.adapter.inbound.api.v1.admin_google_auth_router import router as admin_google_auth_router
...
admin_router.include_router(admin_google_auth_router)
